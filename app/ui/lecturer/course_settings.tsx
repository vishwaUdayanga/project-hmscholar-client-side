                ...
                <div className="w-full mt-10">
                    <div className="mb-4">
                        <div className="flex mt-3 gap-3 mb-4">
                            ...
                            <a href={`${courseSettings?.course_image}?sp=r&st=2024-10-31T18:31:26Z&se=2024-11-30T02:31:26Z&spr=https&sv=2022-11-02&sr=c&sig=CozCjaWmRm7%2BE12IZMWfxzZeS%2FQBqrmF3fiTF2ESUQc%3D`} download className="text-blue-500 underline text-sm">
                                View the file
                            </a>
                        </div>
