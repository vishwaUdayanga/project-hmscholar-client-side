                ...
                <div className="w-full mt-10">
                    <div className="mb-4">
                        <div className="flex mt-3 gap-3 mb-4">
                            ...
                            <a href={`${courseSettings?.course_image}?sp=r&st=2024-10-05T11:14:00Z&se=2024-10-10T19:14:00Z&spr=https&sv=2022-11-02&sr=c&sig=Rjy%2Fa3f9Rc83jftJ9IFakD7ei4k8X8Au7Iy%2BPVy9ClE%3D`} download className="text-blue-500 underline text-sm">
                                View the file
                            </a>
                        </div>
