                                    ...
                                    <ul className="list-disc pl-5">
                                        {section.materials.map((material, index) => (
                                            <li key={index} className="flex gap-3 items-center list-none mt-3">
                                                ...
                                                <a href={`${material.material_path}?sp=r&st=2024-10-31T18:36:02Z&se=2024-11-30T02:36:02Z&spr=https&sv=2022-11-02&sr=c&sig=zqXLdybsURgUk8wD69yVJFRzpIGSE%2Bp04Xb9yjOQdmU%3D`} download className="text-blue-500 underline text-sm">
