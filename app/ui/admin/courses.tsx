                ...
                return (
                    <div className="w-full flex items-center justify-between border-b-slate-300 border-b py-3 cursor-pointer flex-wrap gap-5" key={course.course_id}>
                        ...
                        <div className="flex gap-3">
                            <Link href={`/admin/dashboard/assign-lecturers/${course.course_id}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#0B6EFD" className="bi bi-person-plus-fill" viewBox="0 0 16 16">
