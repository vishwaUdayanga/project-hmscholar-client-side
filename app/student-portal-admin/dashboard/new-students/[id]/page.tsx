                                ...
                                {newStudents.map((student) => (
                                    <tr key={student.newStudent_id}>
                                        ...
                                        <td className="border px-4 py-2">
                                            <a href={`${student.OL_path}?sp=r&st=2024-10-31T18:18:25Z&se=2024-11-30T02:18:25Z&spr=https&sv=2022-11-02&sr=c&sig=l%2BiVz4yvbUgzqXTMSCdie1Xrtl33XnnI%2Fou4rLxlFTE%3D`} download className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
                                                View
                                            </a>
                                        </td>
                                        <td className="border px-4 py-2">
                                            <a href={`${student.AL_path}?sp=r&st=2024-10-31T18:18:25Z&se=2024-11-30T02:18:25Z&spr=https&sv=2022-11-02&sr=c&sig=l%2BiVz4yvbUgzqXTMSCdie1Xrtl33XnnI%2Fou4rLxlFTE%3D`} download className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
                                                View
                                            </a>
                                        </td>
                                        <td className="border px-4 py-2">
                                            <a href={`${student.payment_path}?sp=r&st=2024-10-31T18:18:25Z&se=2024-11-30T02:18:25Z&spr=https&sv=2022-11-02&sr=c&sig=l%2BiVz4yvbUgzqXTMSCdie1Xrtl33XnnI%2Fou4rLxlFTE%3D`} download className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
                                                View
                                            </a>
                                        </td>
